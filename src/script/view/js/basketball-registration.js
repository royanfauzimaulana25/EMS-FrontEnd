...
const basketballRegistration = () => {
    // Get Element ======================================================
    const RegistrationFormBasketballElement = document.getElementById("basketball-form");
    const JenjangElement = document.getElementById('jenjang-basket');
    const SekolahElement = document.getElementById('asal');
    const buttonSubmitBasketball = document.getElementById('button-submit-basketball')

    // Function =========================================================
    // Add Basketball Registration
    const addBasketballHandler = async (event) => {
        event.preventDefault();

        buttonSubmitBasketball.disabled = true;
        buttonSubmitBasketball.innerHTML = `
        ...
        var formElement = document.getElementById("basketball-form");
        var data = new FormData (formElement);

        try {
            let response = await EMSApi.addBasketball(data); 
    ...
    if (RegistrationFormBasketballElement) {
        RegistrationFormBasketballElement.addEventListener("submit", addBasketballHandler);
    };
